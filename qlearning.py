...
print('Estado 5: ', actions_list[policy_function(4)], '..:.. FÉRIAS')
print('Estado 3: ',actions_list[policy_function(2)], '..:..', 'Estado 4 :', actions_list[policy_function(3)])
print('Estado 1: ',actions_list[policy_function(0)], '..:..', 'Estado 2 :', actions_list[policy_function(1)])
